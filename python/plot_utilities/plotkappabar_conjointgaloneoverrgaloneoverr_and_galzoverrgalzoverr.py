...
kappastat_45 = np.c_[   kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_oneoverr_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # 1-1/r
                        ...
                        kappastat.T[kappastat[0]=='fiducial_45_gal_45_oneoverr_120_gal_120_oneoverr_120_zoverr_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # 1/r
...
kappastat_120 = np.c_[  kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # 1-1/r
                        ...
                        kappastat.T[kappastat[0]=='fiducial_45_gal_45_zoverr_120_gal_120_zoverr_120_oneoverr_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # 1/r
...
plt.savefig('%skappashistbar-conjointgaloneoverrgaloneoverr_and_galzoverrgalzoverr.png' % root, dpi=250)
