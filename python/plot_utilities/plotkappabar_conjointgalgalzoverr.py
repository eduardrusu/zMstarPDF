...
kappastat_45 = np.c_[   kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_22.5_med_increments1_1_1_emptymsk.cat'][0][1:].astype(float), # 1-1/r
                        ...
                        kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_120_mass2rms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass2rms
                        kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_120_mass3rms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass3rms
                        kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_120_mass2overrrms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass2overrrms
                        kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_120_mass3overrrms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass3overrrms
                        kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_120_flexion_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # flexion
                        kappastat.T[kappastat[0]=='fiducial_45_gal_120_gal_120_zoverr_120_tidal_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # tidal
...
kappastat_120 = np.c_[  kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_22.5_med_increments1_1_1_emptymsk.cat'][0][1:].astype(float), # 1-1/r
                        ...
                        kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_45_mass2rms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass2rms
                        kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_45_mass3rms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass3rms
                        kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_45_mass2overrrms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass2overrrms
                        kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_45_mass3overrrms_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # mass3overrrms
                        kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_45_flexion_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # flexion
                        kappastat.T[kappastat[0]=='fiducial_120_gal_45_gal_45_zoverr_45_tidal_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # tidal
