...
kappastat_45 = np.c_[   kappastat.T[kappastat[0]=='fiducial_45_gal_45_oneoverr_120_gal_120_gamma_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # 1-1/r
                        ...
                        kappastat.T[kappastat[0]=='fiducial_45_gal_45_oneoverr_120_gal_120_gamma_120_oneoverr_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # 1/r
                        kappastat.T[kappastat[0]=='fiducial_45_gal_45_oneoverr_120_gal_120_gamma_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # z/r
...
kappastat_120 = np.c_[  kappastat.T[kappastat[0]=='fiducial_120_gal_120_oneoverr_120_gal_120_gamma_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # 1-1/r
                        ...
                        kappastat.T[kappastat[0]=='fiducial_45_gal_45_oneoverr_45_oneoverr_120_gal_120_gamma_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # 1/r
                        kappastat.T[kappastat[0]=='fiducial_45_gal_45_oneoverr_45_gal_120_gamma_22.5_med_increments4_4_4_emptymsk.cat'][0][1:].astype(float), # z/r
...
plt.savefig('%skappashistbar-conjointgaloneoverrgalgamma.png' % root, dpi=250)
