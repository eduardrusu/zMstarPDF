...
kappastat_45 = np.c_[   kappastat.T[kappastat[0]=='fiducial_45_gal_45_gamma_120_gal_120_oneoverr_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # 1-1/r
...
kappastat_120 = np.c_[  kappastat.T[kappastat[0]=='fiducial_120_gal_120_gamma_45_gal_45_oneoverr_22.5_med_increments4_4_4_4_emptymsk.cat'][0][1:].astype(float), # 1-1/r
...
ax.set_xticklabels(('$1-1/r$', '$z$',  '$M_\star$', '$M^2_\star$', '$M^3_\star$', '$1/r$', '$z/r$', '$M_\star/r$', '$M^2_\star/r$', '$M^3_\star/r$', '$M^2_{\star\mathrm{rms}}$', '$M^3_{\star\mathrm{rms}}$', '$M^2_\star/r_\mathrm{,rms}$', '$M^3_\star/r_\mathrm{,rms}$', '$M_\star/r^3$', '$M_\star/r^2$', '$\sqrt{M_\star}/r$', '$\sqrt{M_h}/r$'), fontsize=10, rotation='vertical')
ax.legend((rects1[0], rects2[0]), ('22.5 45 gal+1/r 120 gal+$\gamma$+', '120 gal+$\gamma$ 45 gal+1/r+ '), bbox_to_anchor=(0.65, 1.4), fontsize=10)
