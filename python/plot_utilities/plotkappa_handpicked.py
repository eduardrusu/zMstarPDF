...
#plt.plot(kappa_values[:-1][::1],kappa_0[::1],linewidth=1, label ='$45: 1 + 1/r + \gamma$', linestyle=':') # every 1th point
ax.text(0.55, 1.00, s0, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_1[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma + mass$', linestyle='-.') # every 1th point
ax.text(0.55, 0.95, s1, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_2[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1', linestyle='--') # every 1th point
ax.text(0.55, 0.90, s2, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_3[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1 + 1/r') # every 1th point
ax.text(0.55, 0.85, s3, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_4[::1],linewidth=1, label ='$120: 1 + 1/r + \gamma$') # every 1th point
ax.text(0.55, 0.80, s4, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_0[::1],linewidth=1, label ='$45: 1 + 1/r + \gamma$', linestyle=':') # every 1th point
ax.text(0.55, 0.75, s5, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_1[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma + mass$', linestyle='-.') # every 1th point
ax.text(0.55, 0.70, s6, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_2[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1', linestyle='--') # every 1th point
ax.text(0.55, 0.65, s7, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_3[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1 + 1/r') # every 1th point
ax.text(0.55, 0.60, s8, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_4[::1],linewidth=1, label ='$120: 1 + 1/r + \gamma$') # every 1th point
ax.text(0.55, 0.55, s9, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_0[::1],linewidth=1, label ='$45: 1 + 1/r + \gamma$', linestyle=':') # every 1th point
ax.text(0.55, 0.50, s10, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_1[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma + mass$', linestyle='-.') # every 1th point
ax.text(0.55, 0.45, s11, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_2[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1', linestyle='--') # every 1th point
ax.text(0.55, 0.40, s12, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_3[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1 + 1/r') # every 1th point
ax.text(0.55, 0.35, s13, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_4[::1],linewidth=1, label ='$120: 1 + 1/r + \gamma$') # every 1th point
ax.text(0.55, 0.30, s14, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_0[::1],linewidth=1, label ='$45: 1 + 1/r + \gamma$', linestyle=':') # every 1th point
ax.text(0.55, 0.25, s15, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_1[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma + mass$', linestyle='-.') # every 1th point
ax.text(0.55, 0.20, s16, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_2[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1', linestyle='--') # every 1th point
ax.text(0.55, 0.15, s17, fontsize=10, transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_3[::1], linewidth=1, label ='$120: 1 + 1/r + \gamma$; 45: 1 + 1/r') # every 1th point
ax.text(0.55, 0.10, s18, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_4[::1],linewidth=1, label ='$120: 1 + 1/r + \gamma$') # every 1th point
ax.text(0.55, 0.05, s19, fontsize=10,transform=ax.transAxes)
#plt.plot(kappa_values[:-1][::1],kappa_4[::1],linewidth=1, label ='$120: 1 + 1/r + \gamma$') # every 1th point
ax.text(0.55, 0.00, s20, fontsize=10,transform=ax.transAxes)
...
plt.plot(kappa_values[:-1],smooth(kappa_0,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_c,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_1,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_c,z; 120:1,z$')
plt.plot(kappa_values[:-1],smooth(kappa_2,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_c,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_3,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_c,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_4,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_c,1/r; 45:1,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_5,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_c,z/r; 45:1,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_6,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_c,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_7,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_p,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_8,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_p,z; 120:1,z$')
plt.plot(kappa_values[:-1],smooth(kappa_9,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_p,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_10,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,\gamma_p,z/r; 120:1,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_11,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$45: 1,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_12,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_p,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_13,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_p,1/r; 45:1,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_14,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_p,1/r; 45:1,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_15,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_p,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_16,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,\gamma_p,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_17,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_18,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,1/r; 45:1,1/r$')
plt.plot(kappa_values[:-1],smooth(kappa_19,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,1/r; 45:1,z/r$')
plt.plot(kappa_values[:-1],smooth(kappa_20,winlen,'flat')[(winlen/2-1):-(winlen/2)],color='k', linewidth=1, label ='$120: 1,z/r$')
