...
kappa_1  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_gal_23_120_meds_increments2.cat" % root, usecols=[0], unpack=True)
...
kappa_2  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_gal_oneoverr_23_120_meds_increments2_2.cat" % root, usecols=[0], unpack=True)
...
kappa_3  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_gal_gamma_oneoverr_23_120_meds_increments2_2_2.cat" % root, usecols=[0], unpack=True)
