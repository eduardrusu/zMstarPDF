...
if conjoined == 4:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_%s_increments%s_%s_%s_%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,weightin4,mag,radius,mode,increment1,increment2,increment3,increment4)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_%s_LOS_increments%s_%s_%s_%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,weightin4,mag,radius,mode,increment1,increment2,increment3,increment4)
if conjoined == 3:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_increments%s_%s_%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,mag,radius,mode,increment1,increment2,increment3)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_LOS_increments%s_%s_%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,mag,radius,mode,increment1,increment2,increment3)
if conjoined == 2:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_increments%s_%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,weightin2,mag,radius,mode,increment1,increment2)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_LOS_increments%s_%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,weightin2,mag,radius,mode,increment1,increment2)
if conjoined == 1:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_increments%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,mag,radius,mode,increment1)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_LOS_increments%s_500binsE4.cat' % (rootout,lens,innermask,weightin1,mag,radius,mode,increment1)
