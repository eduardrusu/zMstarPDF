...
kappa_0  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_zgap-1.0_-1.0_fiducial_gal_gamma_oneoverr_23_45_meds_increments2_2_2.cat" % root, usecols=[0], unpack=True)
...
kappa_1  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_zgap-1.0_-1.0_fiducial_gal_gamma_oneoverr_23_120_meds_increments2_2_2.cat" % root, usecols=[0], unpack=True)
...
kappa_2  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_zgap-1.0_-1.0_fiducial_120_gal_120_gamma_45_gal_23_meds_increments2_2_2.cat" % root, usecols=[0], unpack=True)
...
kappa_3  = np.loadtxt("%skappahist_WFI2033_5innermask_nobeta_zgap-1.0_-1.0_fiducial_120_gal_120_gamma_120_oneoverr_45_gal_23_meds_increments2_2_2_2.cat" % root, usecols=[0], unpack=True)
...
plt.savefig('%skappahist_fiducial.png' % root, dpi=250, bbox_inches='tight')
