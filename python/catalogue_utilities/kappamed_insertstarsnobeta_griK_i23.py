...
for i in range(4):
    for j in range(4):
        ...
        if "measured" in type:
            ...
            z___griK = z__griK
            z__griK = z___griK[(imag__griK > brightmag) & (imag__griK <= 23) & (z___griK <= z_s) & (((imag__griK > brightmag) & (imag__griK <= 18) & (spec < 1 - inc_griK_18)) | ((imag__griK > 18) & (imag__griK <= 18.5) & (spec < 1 - inc_griK_185)) | ((imag__griK > 18.5) & (imag__griK <= 19) & (spec < 1 - inc_griK_19)) | ((imag__griK > 19) & (imag__griK <= 19.5) & (spec < 1 - inc_griK_195)) | ((imag__griK > 19.5) & (imag__griK <= 20) & (spec < 1 - inc_griK_20)) | ((imag__griK > 20) & (imag__griK <= 20.5) & (spec < 1 - inc_griK_205)) | ((imag__griK > 20.5) & (imag__griK <= 21) & (spec < 1 - inc_griK_21)) | ((imag__griK > 21) & (imag__griK <= 21.5) & (spec < 1 - inc_griK_215)) | ((imag__griK > 21.5) & (imag__griK <= 22) & (spec < 1 - inc_griK_22)) | ((imag__griK > 22) & (imag__griK <= 22.5) & (spec < 1 - inc_griK_225)) | ((imag__griK > 22.5) & (imag__griK <= 23) & (spec < 1 - inc_griK_23)) | ((imag__griK > 23) & (imag__griK <= 23.5) & (spec < 1 - inc_griK_235)) | ((imag__griK > 23.5) & (imag__griK <= 24) & (spec < 1 - inc_griK_24)))]
