...
lensbpz = np.loadtxt('%s/%s%sbpz_nobeta_%s_newsample.cat' % (rootlenscat,lensID,irac,det), unpack=True)
...
fout50_bpzlimbright_1 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_10.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_1 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_10.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_2 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_2 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_3 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_3 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_4 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_4 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_5 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_5 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_6 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_6 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_7 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_7 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_8 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_8 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout50_bpzlimbright_9 = '%s/%s_wghtratios_50_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_9 = '%s/%s_wghtratios_75_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
