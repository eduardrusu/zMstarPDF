# CE Rusu, Feb 13 2018
# The code uses the weighted count ratios derived by weightinguniversal_overlap_sampling_nobeta_WFI2033rethought.py to produce histograms and compute the 16th, 50th and 84th percentiles
...
pltrange = 3
samples = 21
handpickedsamples = 10
if lens != "PG1115": weights = 18
else: weights = 2
#limit = 10**30
limit = np.infty
root = "/u/flashscratch/c/cerusu/weightedcounts/%s/" % lens
#root = "/Volumes/LaCieSubaru/weightedcounts/%s/" % lens
#root = "/Volumes/LaCieSubaru/weightedcounts/PG1115UCLA/%s/" % lens

start_time = time.time()

print "Working on samples:"

medsum50W1 = np.zeros((weights,samples * handpickedsamples))
medsum75W1 = np.zeros((weights,samples * handpickedsamples))
medsum50W2 = np.zeros((weights,samples * handpickedsamples))
medsum75W2 = np.zeros((weights,samples * handpickedsamples))
medsum50W3 = np.zeros((weights,samples * handpickedsamples))
medsum75W3 = np.zeros((weights,samples * handpickedsamples))
medsum50W4 = np.zeros((weights,samples * handpickedsamples))
medsum75W4 = np.zeros((weights,samples * handpickedsamples))

nr = 0
for nr1 in range(handpickedsamples):
  for nr2 in range(samples):
    print '%s/%s' %(nr+1,samples * handpickedsamples)
    if nr == 0:
      if lens != "PG1115":
        ...
        lstW1_75 = [x for x in os.listdir(root) if ('W1' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        #print lstW1_75
        ...
        lstW2_75 = [x for x in os.listdir(root) if ('W2' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        ...
        lstW3_75 = [x for x in os.listdir(root) if ('W3' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        ...
        lstW4_75 = [x for x in os.listdir(root) if ('W4' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) in x) and ('.fits' in x)]
      else:
        #lstW1_75 = [x for x in os.listdir(root) if ('W1' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s_%s%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,str(nr),specialtest) in x)] # select from the files in the root directory
        #lstW1_75 = [x for x in os.listdir(root) if ('W1' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked) in x) and ('_%s.fits' % nr in x)]
        lstW1_75 = [x for x in os.listdir(root) if ('W1' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        #print lstW1_75
        #lstW2_75 = [x for x in os.listdir(root) if ('W2' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s_%s%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,str(nr),specialtest) in x)]
        #lstW2_75 = [x for x in os.listdir(root) if ('W2' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked) in x) and ('_%s.fits' % nr in x)]
        lstW2_75 = [x for x in os.listdir(root) if ('W2' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        #lstW3_75 = [x for x in os.listdir(root) if ('W3' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s_%s%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,str(nr),specialtest) in x)]
        #lstW3_75 = [x for x in os.listdir(root) if ('W3' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked) in x) and ('_%s.fits' % nr in x)]
        lstW3_75 = [x for x in os.listdir(root) if ('W3' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        #lstW4_75 = [x for x in os.listdir(root) if ('W4' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s_%s%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,str(nr),specialtest) in x)]
        #lstW4_75 = [x for x in os.listdir(root) if ('W4' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked) in x) and ('_%s.fits' % nr in x)]
        lstW4_75 = [x for x in os.listdir(root) if ('W4' in x) and ('_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) in x) and ('.fits' in x)]
        print lstW1_75
        print lstW2_75
        print lstW3_75
        print lstW4_75
    ...
    if nr != 0:
      if lens != "PG1115":
        lstW1_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) for x in lstW1_75_0]
        lstW2_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) for x in lstW2_75_0]
        lstW3_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) for x in lstW3_75_0]
        lstW4_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_%s_%s_zgap%s_%s%s%s_%s.fits' %(radius,inner,lens,mag,photz,detect,irac,mode,zinf,zsup,handpicked,nr1,nr2) for x in lstW4_75_0]
      else:
        lstW1_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s.fits' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) for x in lstW1_75_0]
        lstW2_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s.fits' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) for x in lstW2_75_0]
        lstW3_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s.fits' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) for x in lstW3_75_0]
        lstW4_75 = [x[:6]  + '_wghtratios_75_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s%s_%s.fits' %(radius,inner,lens,mag,photz,mode,handpicked,nr1,nr2) for x in lstW4_75_0]
    print "W1..."
...
#        #print np.shape(q_W1_50read)
    for i in range(len(lstW1_75)):
        try:
            ...
            if lens != "PG1115": dataread = np.c_[data.field('5_lens_gal'),data.field('6_lens_zweight'),data.field('7_lens_mass'),data.field('8_lens_mass2'),data.field('9_lens_mass3'),data.field('10_lens_oneoverr'),data.field('11_lens_zoverr'),data.field('12_lens_massoverr'),data.field('13_lens_mass2overr'),data.field('14_lens_mass3overr'),data.field('15_lens_mass2rms'),data.field('16_lens_mass3rms'),data.field('17_lens_mass2overrms'),data.field('18_lens_mass3overrms'),data.field('19_lens_flexion'),data.field('20_lens_tidal'),data.field('21_lens_convergence'),data.field('22_lens_convergencehalo')].T
            else: dataread = np.c_[data.field('5_lens_gal'),data.field('6_lens_oneoverr')].T
            if i == 0:
                q_W1_75read = dataread
            else: q_W1_75read = np.r_['1',q_W1_75read,dataread]
            hdu.close()
        except: print "Skipped nonexistent %s" % lstW1_75[i]
...
#        #print np.shape(q_W2_50read)
    for i in range(len(lstW2_75)):
        try:
            ...
            hdu.close()
        except: print "Skipped nonexistent %s" % lstW2_75[i]
...
#        #print np.shape(q_W3_50read)
    for i in range(len(lstW3_75)):
        try:
            ...
            hdu.close()
        except: print "Skipped nonexistent %s" % lstW3_75[i]
...
#        #print np.shape(q_W4_50read)
    for i in range(len(lstW4_75)):
        try:
            ...
            hdu.close
        except: print "Skipped nonexistent %s" % lstW4_75[i]
...
std50W1_inf = np.zeros(weights)
std50W1_sup = np.zeros(weights)
std50W2_inf = np.zeros(weights)
std50W2_sup = np.zeros(weights)
std50W3_inf = np.zeros(weights)
std50W3_sup = np.zeros(weights)
std50W4_inf = np.zeros(weights)
std50W4_sup = np.zeros(weights)
std75W1_inf = np.zeros(weights)
std75W1_sup = np.zeros(weights)
std75W2_inf = np.zeros(weights)
std75W2_sup = np.zeros(weights)
std75W3_inf = np.zeros(weights)
std75W3_sup = np.zeros(weights)
std75W4_inf = np.zeros(weights)
std75W4_sup = np.zeros(weights)
std_inf = np.zeros(weights)
std_sup = np.zeros(weights)
...
if lens != "PG1115":
    ...
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW1_50%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum50W1.T, fmt='%1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f')
    np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_zgap%s_%s_%ssamplesW1_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, handpicked, samples, specialtest), medsum75W1.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW1_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum75W1.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW2_50%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum50W2.T, fmt='%1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f')
    np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_zgap%s_%s_%ssamplesW2_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, handpicked, samples, specialtest), medsum75W2.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW2_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum75W2.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW3_50%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum50W3.T, fmt='%1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f')
    np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_zgap%s_%s_%ssamplesW3_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, handpicked, samples, specialtest), medsum75W3.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW3_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum75W3.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW4_50%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum50W4.T, fmt='%1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f %1.3f')
    np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_zgap%s_%s_%ssamplesW4_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, handpicked, samples, specialtest), medsum75W4.T, fmt='%1.3f %1.3f')
    #np.savetxt('%s%s_weightedcountshist_%sarcsec_%sinner_%s_%s_%s_%s_%s%s_zgap%s_%s_%ssamplesW4_75%snolim.lst' % (root, lens, radius, inner, mag, mode, photz, detect, irac, handpicked, zinf, zsup, samples, specialtest), medsum75W4.T, fmt='%1.3f %1.3f')
...
good50 = 0
good75 = 0
if lens != "PG1115": lst = [x for x in os.listdir(root) if ('_wghtratios_msk%sarcsecrad%sarcsecgap_%s_%s_%s_%s_zgap%s_%s%s_count%s.cat' %(radius,inner,lens,detect,irac,mode,zinf,zsup,handpicked,specialtest) in x)]
else: lst = [x for x in os.listdir(root) if (('_wghtratios_msk%sarcsecrad%sarcsecgap_%s_%s_zgap%s' %(radius,inner,lens,mode,handpicked) in x) and ('_count.cat' in x))]
