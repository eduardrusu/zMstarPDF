...
if do50 == True: fout50_bpzlimbright_11 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_11 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_12 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_12 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_13 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_13 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_14 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_14 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_15 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_15 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_16 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_16 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_17 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_17 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_18 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_18 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_19 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_19 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if do50 == True: fout50_bpzlimbright_20 = '%s/%s_wghtratios_150_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
fout75_bpzlimbright_20 = '%s/%s_wghtratios_175_%s_%s_%s_bpz_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
...
if photoz == 'bpzeazy':
    ...
    if do50 == True: fout50_eazylimbright_11 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_11 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_12 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_12 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_13 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_13 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_14 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_14 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_15 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_15 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_16 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_16 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_17 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_17 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_18 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_18 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_19 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_19 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_eazylimbright_20 = '%s/%s_wghtratios_150_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
    fout75_eazylimbright_20 = '%s/%s_wghtratios_175_%s_%s_%s_eazy_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,limbright,det,irac,type,zinf,zsup,suffix)
if limmag != brightmag:
    ...
    if do50 == True: fout50_bpzlimmag_11 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_11 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_12 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_12 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_13 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_13 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_14 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_14 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_15 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_15 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_16 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_16 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_17 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_17 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_18 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_18 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_19 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_19 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if do50 == True: fout50_bpzlimmag_20 = '%s/%s_wghtratios_150_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    fout75_bpzlimmag_20 = '%s/%s_wghtratios_175_%s_%s_limmag_bpz_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
    if photoz == 'bpzeazy':
        ...
        if do50 == True: fout50_eazylimmag_11 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_11 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_11.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_12 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_12 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_12.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_13 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_13 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_13.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_14 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_14 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_14.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_15 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_15 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_15.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_16 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_16 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_16.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_17 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_17 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_17.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_18 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_18 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_18.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_19 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_19.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        if do50 == True: fout50_eazylimmag_20 = '%s/%s_wghtratios_150_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
        fout75_eazylimmag_20 = '%s/%s_wghtratios_175_%s_%s_limmag_eazy_%s_%s_%s_zgap%s_%s%s_20.fits' % (output,fieldID[-26:-20],mskname,lensID,det,irac,type,zinf,zsup,suffix)
...
def outputfunc(*argv):
                ...
                for j in range(cells_on_a_side):
                    for n in range(samples):
                        ...
                        if condition == True:
                            ...
                            if n == 20:
                                if start20 == True:
                                    if len(argv) == 37 or len(argv) == 55 or len(argv) == 73 or len(argv) == 109: outlistbpzlimbright_120 = outbpzlimbright
                                    if len(argv) == 55 or len(argv) == 109: outlisteazylimbright_120 = outeazylimbright
                                    if len(argv) == 73 or len(argv) == 109: outlistbpzlimmag_120 = outbpzlimmag
                                    if len(argv) == 109: outlisteazylimmag_120 = outeazylimmag
                                    start20 = False
                                if len(argv) == 37 or len(argv) == 55 or len(argv) == 73 or len(argv) == 109: outlistbpzlimbright_120 = np.c_[outlistbpzlimbright_120,outbpzlimbright]
                                if len(argv) == 55 or len(argv) == 109: outlisteazylimbright_120 = np.c_[outlisteazylimbright_120,outeazylimbright]
                                if len(argv) == 73 or len(argv) == 109: outlistbpzlimmag_120 = np.c_[outlistbpzlimmag_120,outbpzlimmag]
                                if len(argv) == 109: outlisteazylimmag_120 = np.c_[outlisteazylimmag_120,outeazylimmag]
    ...
    if len(argv) == 37: return outlistbpzlimbright_0[:,1:],outlistbpzlimbright_1[:,1:],outlistbpzlimbright_2[:,1:],outlistbpzlimbright_3[:,1:],outlistbpzlimbright_4[:,1:],outlistbpzlimbright_5[:,1:],outlistbpzlimbright_6[:,1:],outlistbpzlimbright_7[:,1:],outlistbpzlimbright_8[:,1:],outlistbpzlimbright_9[:,1:],outlistbpzlimbright_10[:,1:],outlistbpzlimbright_11[:,1:],outlistbpzlimbright_12[:,1:],outlistbpzlimbright_13[:,1:],outlistbpzlimbright_14[:,1:],outlistbpzlimbright_15[:,1:],outlistbpzlimbright_16[:,1:],outlistbpzlimbright_17[:,1:],outlistbpzlimbright_18[:,1:],outlistbpzlimbright_19[:,1:],outlistbpzlimbright_20[:,1:]
