                ...
                for j in range(cells_on_a_side):
                    for n in range(10):
                        ...
                        if (unmaskedcell[k][l][i][j] >= frac_) & (np.min(lens_gal_24bpz_[k][l][i][j]) != 0) & (np.min(lens_gal_23bpz_[k][l][i][j]) != 0) & (np.min(lens_gal_24eazy_[k][l][i][j]) != 0) & (np.min(lens_gal_23eazy_[k][l][i][j]) != 0) & (field_gal_24_[k][l][i][j] != 0) & (field_gal_23_[k][l][i][j] != 0):
                            ...
                            out[2] = i
                            out[3] = j
                            out[4] = round(1.0*lens_gal_24bpz_[k][l][i][j][n]/field_gal_24_[k][l][i][j],4)
                            out[5] = round(1.0*lens_gal_23bpz_[k][l][i][j][n]/field_gal_23_[k][l][i][j],4)
                            out[6] = round(1.0*lens_zweight_24bpz_[k][l][i][j][n]/field_zweight_24_[k][l][i][j],4)
                            out[7] = round(1.0*lens_zweight_23bpz_[k][l][i][j][n]/field_zweight_23_[k][l][i][j],4)
                            out[8] = round(1.0*lens_mass_24bpz_[k][l][i][j][n]/field_mass_24_[k][l][i][j],4)
                            out[9] = round(1.0*lens_mass_23bpz_[k][l][i][j][n]/field_mass_23_[k][l][i][j],4)
                            out[10] = round(1.0*lens_mass2_24bpz_[k][l][i][j][n]/field_mass2_24_[k][l][i][j],4)
                            out[11] = round(1.0*lens_mass2_23bpz_[k][l][i][j][n]/field_mass2_23_[k][l][i][j],4)
                            out[12] = round(1.0*lens_mass3_24bpz_[k][l][i][j][n]/field_mass3_24_[k][l][i][j],4)
                            out[13] = round(1.0*lens_mass3_23bpz_[k][l][i][j][n]/field_mass3_23_[k][l][i][j],4)
                            out[14] = round(1.0*lens_oneoverr_24bpz_[k][l][i][j][n]/field_oneoverr_24_[k][l][i][j],4)
                            out[15] = round(1.0*lens_oneoverr_23bpz_[k][l][i][j][n]/field_oneoverr_23_[k][l][i][j],4)
                            out[16] = round(1.0*lens_zoverr_24bpz_[k][l][i][j][n]/field_zoverr_24_[k][l][i][j],4)
                            out[17] = round(1.0*lens_zoverr_23bpz_[k][l][i][j][n]/field_zoverr_23_[k][l][i][j],4)
                            out[18] = round(1.0*lens_massoverr_24bpz_[k][l][i][j][n]/field_massoverr_24_[k][l][i][j],4)
                            out[19] = round(1.0*lens_massoverr_23bpz_[k][l][i][j][n]/field_massoverr_23_[k][l][i][j],4)
                            out[20] = round(1.0*lens_mass2overr_24bpz_[k][l][i][j][n]/field_mass2overr_24_[k][l][i][j],4)
                            out[21] = round(1.0*lens_mass2overr_23bpz_[k][l][i][j][n]/field_mass2overr_23_[k][l][i][j],4)
                            out[22] = round(1.0*lens_mass3overr_24bpz_[k][l][i][j][n]/field_mass3overr_24_[k][l][i][j],4)
                            out[23] = round(1.0*lens_mass3overr_23bpz_[k][l][i][j][n]/field_mass3overr_23_[k][l][i][j],4)
                            out[24] = round(1.0*lens_mass2rms_24bpz_[k][l][i][j][n]/field_mass2rms_24_[k][l][i][j],4)
                            out[25] = round(1.0*lens_mass2rms_23bpz_[k][l][i][j][n]/field_mass2rms_23_[k][l][i][j],4)
                            out[26] = round(1.0*lens_mass3rms_24bpz_[k][l][i][j][n]/field_mass3rms_24_[k][l][i][j],4)
                            out[27] = round(1.0*lens_mass3rms_23bpz_[k][l][i][j][n]/field_mass3rms_23_[k][l][i][j],4)
                            out[28] = round(1.0*lens_mass2overrms_24bpz_[k][l][i][j][n]/field_mass2overrms_24_[k][l][i][j],4)
                            out[29] = round(1.0*lens_mass2overrms_23bpz_[k][l][i][j][n]/field_mass2overrms_23_[k][l][i][j],4)
                            out[30] = round(1.0*lens_mass3overrms_24bpz_[k][l][i][j][n]/field_mass3overrms_24_[k][l][i][j],4)
                            out[31] = round(1.0*lens_mass3overrms_23bpz_[k][l][i][j][n]/field_mass3overrms_23_[k][l][i][j],4)
                            out[32] = round(1.0*lens_flexion_24bpz_[k][l][i][j][n]/field_flexion_24_[k][l][i][j],4)
                            out[33] = round(1.0*lens_flexion_23bpz_[k][l][i][j][n]/field_flexion_23_[k][l][i][j],4)
                            out[34] = round(1.0*lens_tidal_24bpz_[k][l][i][j][n]/field_tidal_24_[k][l][i][j],4)
                            out[35] = round(1.0*lens_tidal_23bpz_[k][l][i][j][n]/field_tidal_23_[k][l][i][j],4)
                            out[36] = round(1.0*lens_convergence_24bpz_[k][l][i][j][n]/field_convergence_24_[k][l][i][j],4)
                            out[37] = round(1.0*lens_convergence_23bpz_[k][l][i][j][n]/field_convergence_23_[k][l][i][j],4)
                            out[38] = round(1.0*lens_convergencehalo_24bpz_[k][l][i][j][n]/field_convergencehalo_24_[k][l][i][j],4)
                            out[39] = round(1.0*lens_convergencehalo_23bpz_[k][l][i][j][n]/field_convergencehalo_23_[k][l][i][j],4)
                            out[40] = round(1.0*lens_gal_24eazy_[k][l][i][j][n]/field_gal_24_[k][l][i][j],4)
                            out[41] = round(1.0*lens_gal_23eazy_[k][l][i][j][n]/field_gal_23_[k][l][i][j],4)
                            out[42] = round(1.0*lens_zweight_24eazy_[k][l][i][j][n]/field_zweight_24_[k][l][i][j],4)
                            out[43] = round(1.0*lens_zweight_23eazy_[k][l][i][j][n]/field_zweight_23_[k][l][i][j],4)
                            out[44] = round(1.0*lens_mass_24eazy_[k][l][i][j][n]/field_mass_24_[k][l][i][j],4)
                            out[45] = round(1.0*lens_mass_23eazy_[k][l][i][j][n]/field_mass_23_[k][l][i][j],4)
                            out[46] = round(1.0*lens_mass2_24eazy_[k][l][i][j][n]/field_mass2_24_[k][l][i][j],4)
                            out[47] = round(1.0*lens_mass2_23eazy_[k][l][i][j][n]/field_mass2_23_[k][l][i][j],4)
                            out[48] = round(1.0*lens_mass3_24eazy_[k][l][i][j][n]/field_mass3_24_[k][l][i][j],4)
                            out[49] = round(1.0*lens_mass3_23eazy_[k][l][i][j][n]/field_mass3_23_[k][l][i][j],4)
                            out[50] = round(1.0*lens_oneoverr_24eazy_[k][l][i][j][n]/field_oneoverr_24_[k][l][i][j],4)
                            out[51] = round(1.0*lens_oneoverr_23eazy_[k][l][i][j][n]/field_oneoverr_23_[k][l][i][j],4)
                            out[52] = round(1.0*lens_zoverr_24eazy_[k][l][i][j][n]/field_zoverr_24_[k][l][i][j],4)
                            out[53] = round(1.0*lens_zoverr_23eazy_[k][l][i][j][n]/field_zoverr_23_[k][l][i][j],4)
                            out[54] = round(1.0*lens_massoverr_24eazy_[k][l][i][j][n]/field_massoverr_24_[k][l][i][j],4)
                            out[55] = round(1.0*lens_massoverr_23eazy_[k][l][i][j][n]/field_massoverr_23_[k][l][i][j],4)
                            out[56] = round(1.0*lens_mass2overr_24eazy_[k][l][i][j][n]/field_mass2overr_24_[k][l][i][j],4)
                            out[57] = round(1.0*lens_mass2overr_23eazy_[k][l][i][j][n]/field_mass2overr_23_[k][l][i][j],4)
                            out[58] = round(1.0*lens_mass3overr_24eazy_[k][l][i][j][n]/field_mass3overr_24_[k][l][i][j],4)
                            out[59] = round(1.0*lens_mass3overr_23eazy_[k][l][i][j][n]/field_mass3overr_23_[k][l][i][j],4)
                            out[60] = round(1.0*lens_mass2rms_24eazy_[k][l][i][j][n]/field_mass2rms_24_[k][l][i][j],4)
                            out[61] = round(1.0*lens_mass2rms_23eazy_[k][l][i][j][n]/field_mass2rms_23_[k][l][i][j],4)
                            out[62] = round(1.0*lens_mass3rms_24eazy_[k][l][i][j][n]/field_mass3rms_24_[k][l][i][j],4)
                            out[63] = round(1.0*lens_mass3rms_23eazy_[k][l][i][j][n]/field_mass3rms_23_[k][l][i][j],4)
                            out[64] = round(1.0*lens_mass2overrms_24eazy_[k][l][i][j][n]/field_mass2overrms_24_[k][l][i][j],4)
                            out[65] = round(1.0*lens_mass2overrms_23eazy_[k][l][i][j][n]/field_mass2overrms_23_[k][l][i][j],4)
                            out[66] = round(1.0*lens_mass3overrms_24eazy_[k][l][i][j][n]/field_mass3overrms_24_[k][l][i][j],4)
                            out[67] = round(1.0*lens_mass3overrms_23eazy_[k][l][i][j][n]/field_mass3overrms_23_[k][l][i][j],4)
                            out[68] = round(1.0*lens_flexion_24eazy_[k][l][i][j][n]/field_flexion_24_[k][l][i][j],4)
                            out[69] = round(1.0*lens_flexion_23eazy_[k][l][i][j][n]/field_flexion_23_[k][l][i][j],4)
                            out[70] = round(1.0*lens_tidal_24eazy_[k][l][i][j][n]/field_tidal_24_[k][l][i][j],4)
                            out[71] = round(1.0*lens_tidal_23eazy_[k][l][i][j][n]/field_tidal_23_[k][l][i][j],4)
                            out[72] = round(1.0*lens_convergence_24eazy_[k][l][i][j][n]/field_convergence_24_[k][l][i][j],4)
                            out[73] = round(1.0*lens_convergence_23eazy_[k][l][i][j][n]/field_convergence_23_[k][l][i][j],4)
                            out[74] = round(1.0*lens_convergencehalo_24eazy_[k][l][i][j][n]/field_convergencehalo_24_[k][l][i][j],4)
                            out[75] = round(1.0*lens_convergencehalo_23eazy_[k][l][i][j][n]/field_convergencehalo_23_[k][l][i][j],4)
                            if n == 0:
...
t.write(fout50)
outlist50_1.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_2.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_3.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_4.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_5.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_6.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_7.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_8.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
outlist50_9.T.dtype=[('1_overlap_x',np.int16),('2_overlap_y',np.int16),('3_cell_x',np.int16),('4_cell_y',np.int16),('5_lens_gal_24bpz',np.float32),('6_lens_gal_23bpz',np.float32),('7_lens_zweight_24bpz',np.float32),('8_lens_zweight_23bpz',np.float32),('9_lens_mass_24bpz',np.float32),('10_lens_mass_23bpz',np.float32),('11_lens_mass2_24bpz',np.float32),('12_lens_mass2_23bpz',np.float32),('13_lens_mass3_24bpz',np.float32),('14_lens_mass3_23bpz',np.float32),('15_lens_oneoverr_24bpz',np.float32),('16_lens_oneoverr_23bpz',np.float32),('17_lens_zoverr_24bpz',np.float32),('18_lens_zoverr_23bpz',np.float32),('19_lens_massoverr_24bpz',np.float32),('20_lens_massoverr_23bpz',np.float32),('21_lens_mass2overr_24bpz',np.float32),('22_lens_mass2overr_23bpz',np.float32),('23_lens_mass3overr_24bpz',np.float32),('24_lens_mass3overr_23bpz',np.float32),('25_lens_mass2rms_24bpz',np.float32),('26_lens_mass2rms_23bpz',np.float32),('27_lens_mass3rms_24bpz',np.float32),('28_lens_mass3rms_23bpz',np.float32),('29_lens_mass2overrms_24bpz',np.float32),('30_lens_mass2overrms_23bpz',np.float32),('31_lens_mass3overrms_24bpz',np.float32),('32_lens_mass3overrms_23bpz',np.float32),('33_lens_flexion_24bpz',np.float32),('34_lens_flexion_23bpz',np.float32),('35_lens_tidal_24bpz',np.float32),('36_lens_tidal_23bpz',np.float32),('37_lens_convergence_24bpz',np.float32),('38_lens_convergence_23bpz',np.float32),('39_lens_convergencehalo_24bpz',np.float32),('40_lens_convergencehalo_23bpz',np.float32),('41_lens_gal_24eazy',np.float32),('42_lens_gal_23eazy',np.float32),('43_lens_zweight_24eazy',np.float32),('44_lens_zweight_23eazy',np.float32),('45_lens_mass_24eazy',np.float32),('46_lens_mass_23eazy',np.float32),('47_lens_mass2_24eazy',np.float32),('48_lens_mass2_23eazy',np.float32),('49_lens_mass3_24eazy',np.float32),('50_lens_mass3_23eazy',np.float32),('51_lens_oneoverr_24eazy',np.float32),('52_lens_oneoverr_23eazy',np.float32),('53_lens_zoverr_24eazy',np.float32),('54_lens_zoverr_23eazy',np.float32),('55_lens_massoverr_24eazy',np.float32),('56_lens_massoverr_23eazy',np.float32),('57_lens_mass2overr_24eazy',np.float32),('58_lens_mass2overr_23eazy',np.float32),('59_lens_mass3overr_24eazy',np.float32),('60_lens_mass3overr_23eazy',np.float32),('61_lens_mass2rms_24eazy',np.float32),('62_lens_mass2rms_23eazy',np.float32),('63_lens_mass3rms_24eazy',np.float32),('64_lens_mass3rms_23eazy',np.float32),('65_lens_mass2overrms_24eazy',np.float32),('66_lens_mass2overrms_23eazy',np.float32),('67_lens_mass3overrms_24eazy',np.float32),('68_lens_mass3overrms_23eazy',np.float32),('69_lens_flexion_24eazy',np.float32),('70_lens_flexion_23eazy',np.float32),('71_lens_tidal_24eazy',np.float32),('72_lens_tidal_23eazy',np.float32),('73_lens_convergence_24eazy',np.float32),('74_lens_convergence_23eazy',np.float32),('75_lens_convergencehalo_24eazy',np.float32),('76_lens_convergencehalo_23eazy',np.float32)]
