                ...
                for j in range(cells_on_a_side):
                    for n in range(10):
                        ...
                        if (unmaskedcell[k][l][i][j] >= frac) & (np.min(lens_gal_24bpz_[k][l][i][j]) != 0) & (np.min(lens_gal_23bpz_[k][l][i][j]) != 0) & (np.min(lens_gal_24eazy_[k][l][i][j]) != 0) & (np.min(lens_gal_23eazy_[k][l][i][j]) != 0) & (field_gal_24_[k][l][i][j] != 0) & (field_gal_23_[k][l][i][j] != 0):
                            ...
                            out[2] = i
                            out[3] = j
                            out[4] = 1.0*lens_gal_24bpz_[k][l][i][j][n]/field_gal_24_[k][l][i][j]
                            out[5] = 1.0*lens_gal_23bpz_[k][l][i][j][n]/field_gal_23_[k][l][i][j]
                            out[6] = 1.0*lens_zweight_24bpz_[k][l][i][j][n]/field_zweight_24_[k][l][i][j]
                            out[7] = 1.0*lens_zweight_23bpz_[k][l][i][j][n]/field_zweight_23_[k][l][i][j]
                            out[8] = 1.0*lens_mass_24bpz_[k][l][i][j][n]/field_mass_24_[k][l][i][j]
                            out[9] = 1.0*lens_mass_23bpz_[k][l][i][j][n]/field_mass_23_[k][l][i][j]
                            out[10] = 1.0*lens_mass2_24bpz_[k][l][i][j][n]/field_mass2_24_[k][l][i][j]
                            out[11] = 1.0*lens_mass2_23bpz_[k][l][i][j][n]/field_mass2_23_[k][l][i][j]
                            out[12] = 1.0*lens_mass3_24bpz_[k][l][i][j][n]/field_mass3_24_[k][l][i][j]
                            out[13] = 1.0*lens_mass3_23bpz_[k][l][i][j][n]/field_mass3_23_[k][l][i][j]
                            out[14] = 1.0*lens_oneoverr_24bpz_[k][l][i][j][n]/field_oneoverr_24_[k][l][i][j]
                            out[15] = 1.0*lens_oneoverr_23bpz_[k][l][i][j][n]/field_oneoverr_23_[k][l][i][j]
                            out[16] = 1.0*lens_zoverr_24bpz_[k][l][i][j][n]/field_zoverr_24_[k][l][i][j]
                            out[17] = 1.0*lens_zoverr_23bpz_[k][l][i][j][n]/field_zoverr_23_[k][l][i][j]
                            out[18] = 1.0*lens_massoverr_24bpz_[k][l][i][j][n]/field_massoverr_24_[k][l][i][j]
                            out[19] = 1.0*lens_massoverr_23bpz_[k][l][i][j][n]/field_massoverr_23_[k][l][i][j]
                            out[20] = 1.0*lens_mass2overr_24bpz_[k][l][i][j][n]/field_mass2overr_24_[k][l][i][j]
                            out[21] = 1.0*lens_mass2overr_23bpz_[k][l][i][j][n]/field_mass2overr_23_[k][l][i][j]
                            out[22] = 1.0*lens_mass3overr_24bpz_[k][l][i][j][n]/field_mass3overr_24_[k][l][i][j]
                            out[23] = 1.0*lens_mass3overr_23bpz_[k][l][i][j][n]/field_mass3overr_23_[k][l][i][j]
                            out[24] = 1.0*lens_mass2rms_24bpz_[k][l][i][j][n]/field_mass2rms_24_[k][l][i][j]
                            out[25] = 1.0*lens_mass2rms_23bpz_[k][l][i][j][n]/field_mass2rms_23_[k][l][i][j]
                            out[26] = 1.0*lens_mass3rms_24bpz_[k][l][i][j][n]/field_mass3rms_24_[k][l][i][j]
                            out[27] = 1.0*lens_mass3rms_23bpz_[k][l][i][j][n]/field_mass3rms_23_[k][l][i][j]
                            out[28] = 1.0*lens_mass2overrms_24bpz_[k][l][i][j][n]/field_mass2overrms_24_[k][l][i][j]
                            out[29] = 1.0*lens_mass2overrms_23bpz_[k][l][i][j][n]/field_mass2overrms_23_[k][l][i][j]
                            out[30] = 1.0*lens_mass3overrms_24bpz_[k][l][i][j][n]/field_mass3overrms_24_[k][l][i][j]
                            out[31] = 1.0*lens_mass3overrms_23bpz_[k][l][i][j][n]/field_mass3overrms_23_[k][l][i][j]
                            out[32] = 1.0*lens_flexion_24bpz_[k][l][i][j][n]/field_flexion_24_[k][l][i][j]
                            out[33] = 1.0*lens_flexion_23bpz_[k][l][i][j][n]/field_flexion_23_[k][l][i][j]
                            out[34] = 1.0*lens_tidal_24bpz_[k][l][i][j][n]/field_tidal_24_[k][l][i][j]
                            out[35] = 1.0*lens_tidal_23bpz_[k][l][i][j][n]/field_tidal_23_[k][l][i][j]
                            out[36] = 1.0*lens_convergence_24bpz_[k][l][i][j][n]/field_convergence_24_[k][l][i][j]
                            out[37] = 1.0*lens_convergence_23bpz_[k][l][i][j][n]/field_convergence_23_[k][l][i][j]
                            out[38] = 1.0*lens_convergencehalo_24bpz_[k][l][i][j][n]/field_convergencehalo_24_[k][l][i][j]
                            out[39] = 1.0*lens_convergencehalo_23bpz_[k][l][i][j][n]/field_convergencehalo_23_[k][l][i][j]
                            out[40] = 1.0*lens_gal_24eazy_[k][l][i][j][n]/field_gal_24_[k][l][i][j]
                            out[41] = 1.0*lens_gal_23eazy_[k][l][i][j][n]/field_gal_23_[k][l][i][j]
                            out[42] = 1.0*lens_zweight_24eazy_[k][l][i][j][n]/field_zweight_24_[k][l][i][j]
                            out[43] = 1.0*lens_zweight_23eazy_[k][l][i][j][n]/field_zweight_23_[k][l][i][j]
                            out[44] = 1.0*lens_mass_24eazy_[k][l][i][j][n]/field_mass_24_[k][l][i][j]
                            out[45] = 1.0*lens_mass_23eazy_[k][l][i][j][n]/field_mass_23_[k][l][i][j]
                            out[46] = 1.0*lens_mass2_24eazy_[k][l][i][j][n]/field_mass2_24_[k][l][i][j]
                            out[47] = 1.0*lens_mass2_23eazy_[k][l][i][j][n]/field_mass2_23_[k][l][i][j]
                            out[48] = 1.0*lens_mass3_24eazy_[k][l][i][j][n]/field_mass3_24_[k][l][i][j]
                            out[49] = 1.0*lens_mass3_23eazy_[k][l][i][j][n]/field_mass3_23_[k][l][i][j]
                            out[50] = 1.0*lens_oneoverr_24eazy_[k][l][i][j][n]/field_oneoverr_24_[k][l][i][j]
                            out[51] = 1.0*lens_oneoverr_23eazy_[k][l][i][j][n]/field_oneoverr_23_[k][l][i][j]
                            out[52] = 1.0*lens_zoverr_24eazy_[k][l][i][j][n]/field_zoverr_24_[k][l][i][j]
                            out[53] = 1.0*lens_zoverr_23eazy_[k][l][i][j][n]/field_zoverr_23_[k][l][i][j]
                            out[54] = 1.0*lens_massoverr_24eazy_[k][l][i][j][n]/field_massoverr_24_[k][l][i][j]
                            out[55] = 1.0*lens_massoverr_23eazy_[k][l][i][j][n]/field_massoverr_23_[k][l][i][j]
                            out[56] = 1.0*lens_mass2overr_24eazy_[k][l][i][j][n]/field_mass2overr_24_[k][l][i][j]
                            out[57] = 1.0*lens_mass2overr_23eazy_[k][l][i][j][n]/field_mass2overr_23_[k][l][i][j]
                            out[58] = 1.0*lens_mass3overr_24eazy_[k][l][i][j][n]/field_mass3overr_24_[k][l][i][j]
                            out[59] = 1.0*lens_mass3overr_23eazy_[k][l][i][j][n]/field_mass3overr_23_[k][l][i][j]
                            out[60] = 1.0*lens_mass2rms_24eazy_[k][l][i][j][n]/field_mass2rms_24_[k][l][i][j]
                            out[61] = 1.0*lens_mass2rms_23eazy_[k][l][i][j][n]/field_mass2rms_23_[k][l][i][j]
                            out[62] = 1.0*lens_mass3rms_24eazy_[k][l][i][j][n]/field_mass3rms_24_[k][l][i][j]
                            out[63] = 1.0*lens_mass3rms_23eazy_[k][l][i][j][n]/field_mass3rms_23_[k][l][i][j]
                            out[64] = 1.0*lens_mass2overrms_24eazy_[k][l][i][j][n]/field_mass2overrms_24_[k][l][i][j]
                            out[65] = 1.0*lens_mass2overrms_23eazy_[k][l][i][j][n]/field_mass2overrms_23_[k][l][i][j]
                            out[66] = 1.0*lens_mass3overrms_24eazy_[k][l][i][j][n]/field_mass3overrms_24_[k][l][i][j]
                            out[67] = 1.0*lens_mass3overrms_23eazy_[k][l][i][j][n]/field_mass3overrms_23_[k][l][i][j]
                            out[68] = 1.0*lens_flexion_24eazy_[k][l][i][j][n]/field_flexion_24_[k][l][i][j]
                            out[69] = 1.0*lens_flexion_23eazy_[k][l][i][j][n]/field_flexion_23_[k][l][i][j]
                            out[70] = 1.0*lens_tidal_24eazy_[k][l][i][j][n]/field_tidal_24_[k][l][i][j]
                            out[71] = 1.0*lens_tidal_23eazy_[k][l][i][j][n]/field_tidal_23_[k][l][i][j]
                            out[72] = 1.0*lens_convergence_24eazy_[k][l][i][j][n]/field_convergence_24_[k][l][i][j]
