...
kappa_0  = np.loadtxt("%skappahist_WFI2033_15innermask_nobeta_zgap-1.0_-1.0_fiducial_120_gal_120_gamma_120_oneoverr_23_meds_increments2_2_2_emptymsk.cat" % root, usecols=[0], unpack=True)
...
plt.savefig('%skappahist_15msk.png' % root, dpi=250, bbox_inches='tight')
