...
if removegroups == 'removegroups': groupsfile = np.loadtxt(rootcode+'8_0_0groups24.5.cat',usecols=[2,3,8],unpack=True)
...
if removegroups == 'removegroups': groupsstr = '_removegroups24.5'
else: groupsstr = ''
if conjoined == 5:
