...
if conjoined == 4:
    ...
    output = '%sgamma008kappahist_%s_%s_%sinnermask_nobeta%s_zgap%s_%s_%s_%s_%s_%s_%s_%s_%s_increments%s_%s_%s_%s%s%s%s%s.cat' % (rootout,lens,compmeas,innermask,handpickedstr,zinf,zsup,other,weightin1,weightin2,weightin3,weightin4,mag,mode,increment1,increment2,increment3,increment4,emptystr,groupsstr,stringshearprior,sam)
if conjoined == 3:
    if ((type(weight2_index) != int) | (type(weight3_index) != int)) & (shearwithoutprior == True): stringshearprior = '_shearwithoutprior'
    else: stringshearprior = ''
    output = '%sgamma008kappahist_%s_%s_%sinnermask_nobeta%s_zgap%s_%s_%s_%s_%s_%s_%s_%s_increments%s_%s_%s%s%s%s%s.cat' % (rootout,lens,compmeas,innermask,handpickedstr,zinf,zsup,other,weightin1,weightin2,weightin3,mag,mode,increment1,increment2,increment3,emptystr,groupsstr,stringshearprior,sam)
if conjoined == 2:
    if (type(weight2_index) != int) & (shearwithoutprior == True): stringshearprior = '_shearwithoutprior'
    else: stringshearprior = ''
    output = '%sgamma008kappahist_%s_%s_%sinnermask_nobeta%s_zgap%s_%s_%s_%s_%s_%s_%s_increments%s_%s%s%s%s%s.cat' % (rootout,lens,compmeas,innermask,handpickedstr,zinf,zsup,other,weightin1,weightin2,mag,mode,increment1,increment2,emptystr,groupsstr,stringshearprior,sam)
if conjoined == 1:
    output = '%sgamma008kappahist_%s_%s_%sinnermask_nobeta%s_zgap%s_%s_%s_%s_%s_%s_increments%s%s%s%s.cat' % (rootout,lens,compmeas,innermask,handpickedstr,zinf,zsup,other,weightin1,mag,mode,increment1,emptystr,groupsstr,sam)
