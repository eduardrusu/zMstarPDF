# Run as python inferkappa_unbiasedwithshear8of64fields.py WFI2033 5 45 23 meds gal gamma oneoverr mass
...
if conjoined == 4:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_%s_8of64fields_increments%s_%s_%s_%s.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,weightin4,mag,radius,mode,increment1,increment2,increment3,increment4)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_%s_LOS_8of64fields_increments%s_%s_%s_%s.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,weightin4,mag,radius,mode,increment1,increment2,increment3,increment4)
if conjoined == 3:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_8of64fields_increments%s_%s_%s.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,mag,radius,mode,increment1,increment2,increment3)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_LOS_8of64fields_increments%s_%s_%s.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,mag,radius,mode,increment1,increment2,increment3)
if conjoined == 2:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_8of64fields_increments%s_%s.cat' % (rootout,lens,innermask,weightin1,weightin2,mag,radius,mode,increment1,increment2)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_LOS_8of64fields_increments%s_%s.cat' % (rootout,lens,innermask,weightin1,weightin2,mag,radius,mode,increment1,increment2)
if conjoined == 1:
    output = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_8of64fields_increments%s.cat' % (rootout,lens,innermask,weightin1,mag,radius,mode,increment1)
    outputLOS = '%skappahist_%s_%sinnermask_nobeta_%s_%s_%s_%s_LOS_8of64fields_increments%s.cat' % (rootout,lens,innermask,weightin1,mag,radius,mode,increment1)
