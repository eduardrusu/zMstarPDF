...
lensbpz = np.loadtxt('%s/%s%sbpz_nobeta_%s_testsampleduplication.cat' % (rootlenscat,lensID,irac,det), unpack=True)
lenseazy = np.loadtxt('%s/%s%seazy_nobeta_%s_testsampleduplication.cat' % (rootlenscat,lensID,irac,det), unpack=True)
...
fcount = open('%s/%s_%s_%s_%s_%s_%s_zgap%s_%s%s_count_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'w') # [-25:-4] corresponds to strings of the form W1m0m0_24galphotmstar
fcount.write(count)
fcount.close()

os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_0_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix)) # '-f' ignores non-existent files
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_0_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_1_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_1_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_2_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_2_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_3_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_3_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_4_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_4_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_5_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_5_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_6_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_6_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_7_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_7_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_8_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_8_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_9_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))
os.system('rm -f %s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_9_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix))

file50_0 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_0_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_0 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_0_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_1 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_1_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_1 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_1_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_2 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_2_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_2 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_2_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_3 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_3_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_3 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_3_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_4 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_4_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_4 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_4_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_5 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_5_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_5 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_5_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_6 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_6_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_6 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_6_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_7 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_7_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_7 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_7_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_8 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_8_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_8 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_8_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file50_9 = open('%s/%s_50_%s_%s_%s_%s_%s_zgap%s_%s%s_9_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
file75_9 = open('%s/%s_75_%s_%s_%s_%s_%s_zgap%s_%s%s_9_testsampleduplication.lst' % (output,fieldID[-25:-4],mskname,lensID,det,irac,type,zinf,zsup,suffix),'a')
