...
# Run as python inferkappasimbiasphil.py WFI2033 5 45 23 meds gal gamma oneoverr mass
...
if conjoined == 4:
    output = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_%s_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,weightin4,mag,radius,mode)
    outputLOS = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_%s_LOS_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,weightin4,mag,radius,mode)
if conjoined == 3:
    output = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,mag,radius,mode)
    outputLOS = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_%s_LOS_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,weightin2,weightin3,mag,radius,mode)
if conjoined == 2:
    output = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,weightin2,mag,radius,mode)
    outputLOS = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_%s_LOS_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,weightin2,mag,radius,mode)
if conjoined == 1:
    output = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,mag,radius,mode)
    outputLOS = '%skappasimbiasphil_%s_%sinnermask_nobeta_%s_%s_%s_%s_LOS_8of64fields_increments.cat' % (rootout,lens,innermask,weightin1,mag,radius,mode)
...
if conjoined == 4:
    ...
    np.savetxt(output,product,fmt='%s',delimiter='\t',newline='\n')
